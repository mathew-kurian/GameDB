  ...
  render(){
    return (
      <div style={{background:this.props.theme}}>
        <div className="container" style={{position:'relative',left:-30}}>
        ...
        <div style={{padding:'50px 0',width:'100%',background:this.props.theme}}>
          <div className="container">
            <h1 style={{fontSize:'41px',color:'#000',fontWeight:'bold',letterSpacing:'1px',textTransform:'uppercase'}}>{this.props.title}</h1>
