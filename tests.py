...
class TestGames(TestCase):
    ...
    def test_game3(self):
        ...
        session.add(game)
        session.commit()
        #test specific cases and check if dictionary entries were added correctly
    ...
    def test_company1(self):
        company = Company("Nintendo", "address", "city", "state", "Japan", "123-456-7890", "nintendo.com",
                          "It's nintendo")
        session.add(company)
        session.commit()
    ...
    def test_company3(self):
        args = {"developed_games": ["Sports simulator 2015", "Another Sports simluator 2014"],
                "published_games": ["the Sims 1", "The Sims 2-4"]}
    ...
    def test_platform3(self):
        args = {"games": ["Halo", "Star Wars Battlefront 2", "Call of Duty: Modern Warfare"],
                "companies": ["Bungie", "Infinity Ward"]}
